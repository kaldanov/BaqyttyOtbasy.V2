...
import com.telegrambot.service.ServiceReportServiceForSpec;
...
public class id057_ReportService extends Command {
...
//        }
    ...
    private void    sendReport()    throws TelegramApiException {
        ...
        ServiceReportServiceForSpec reportService  = new ServiceReportServiceForSpec();
