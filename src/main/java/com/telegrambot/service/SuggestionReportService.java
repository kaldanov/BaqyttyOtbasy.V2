...
import com.telegrambot.repository.SuggestionRepository;
...
public class SuggestionReportService {
    ...
    private String path;
    public SuggestionReportService(MessageRepository messageRepository, SuggestionRepository suggestionRepository) {
    ...
    private void            sendCompReport(long chatId, DefaultAbsSender bot, Date dateBegin, Date dateEnd, int messagePrevReport) throws TelegramApiException, IOException {
        ...
        List<Suggestion> reports    = suggestionRepository.findAllByPostDateBetweenOrderById(dateBegin, dateEnd);
    ...
    private void sendFile(long chatId, DefaultAbsSender bot, Date dateBegin, Date dateEnd) throws IOException, TelegramApiException {
        String fileName = "Жалобы за: " + com.telegrambot.util.DateUtil.getDayDate(dateBegin) + " - " + DateUtil.getDayDate(dateEnd) + ".xlsx";
